#include "deneyap.h"
#include <Deneyap_Servo.h>  // Eğer bu kütüphane çalışmaz ise <ESP32Servo.h>
kütüphanesi denenebilir.
#define SW1_pin D0
#define SW2_pin D1
#define X1_pin A0
#define Y1_pin A1
...
void setup() {
  myservo1.attach(SERVOPIN1);  //Eğer <ESP32Servo.h> kütüphanesi kullanırsanız, bu ve
  aşağıdaki 3 satırda parantez içerisindeki 2’inci parametreyi silin, tek parametre yeterlidir.myservo2.attach(SERVOPIN2, 1);
